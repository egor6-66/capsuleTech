...
|---|---|---|---|
| [[#entity]] | Haiku 4.5 | Stateless Entity | `apps/<app>/src/entities/<group>/<name>.tsx` |
| [[#widget]] | Haiku 4.5 | Композиция Entity+Controller+Feature | `apps/<app>/src/widgets/<group>/<name>.tsx` |
...
- **Universal** (попадают в CLI templates → копируются в user-workspace): `app`, `entity`, `widget`, `page`, `shape`, `controller`, `feature`.
