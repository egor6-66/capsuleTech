...
1. **Phase 0 — новый ADR.** Главный заводит ADR (свободный номер на момент создания) «Docs-as-data — per-package distribution». Решает open questions §1–5. Замещает ADR 048 D4 + D5 (но НЕ D1–D3, D6 — они остаются canon).
