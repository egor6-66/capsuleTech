...
### Pain 1 — Несколько аудиторий, одна тема, риск дрейфа
...
### Pain 2 — Программно неудобно консьюмить .md
...
### D1 — Single markdown source-of-truth
...
### D2 — Section-ID convention (стабильные anchors)
...
### D3 — Audience-tagging через HTML-комменты
...
### D4 — Build-time extraction → typed registry
...
### D5 — `@capsuletech/studio/docs` consumer
...
## Что НЕ решает ADR 048 (явно вне scope)
