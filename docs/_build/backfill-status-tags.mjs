...
const MAPPING = {
  // status — 7 docs
  'docs/_archive/agent-prompts/actions/Init.md': {
    status: 'deprecated',
  ...
  'docs/_meta/briefs/owner-web-router-capsule-outlet.md': {
    tags: ['brief', 'owner-web-router', 'C1'],
  },
  'docs/_meta/briefs/owner-web-style-C3-vt-css-enumerate.md': {
    tags: ['brief', 'owner-web-style', 'C3'],
  },
  'docs/_meta/briefs/owner-web-ui-B6-light-placeholders.md': {
    tags: ['brief', 'owner-web-ui', 'B6'],
  },
  'docs/_meta/briefs/owner-web-ui-W4-bundle-size-manifest.md': {
    tags: ['brief', 'owner-web-ui', 'W4'],
  },
  'docs/_meta/briefs/owner-web-ui-W4-phase2-bundle-assertions.md': {
    tags: ['brief', 'owner-web-ui', 'W4'],
  },
