"""Synset-aware related ranking (ADR 064-A, prefix /lang per ADR 067 D2)."""

from __future__ import annotations


def _id_by_text(client, word: str) -> int:
    senses = client.get("/lang/senses", params={"pos": "adj"}).json()["senses"]
...
def test_related_happy(client):
    ...
    related = client.get(
        "/lang/senses/related", params={"sense": happy}
    ).json()["related"]
...
def test_related_empty_for_unknown(client):
    r = client.get("/lang/senses/related", params={"sense": 99999})
