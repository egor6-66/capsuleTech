...
- **Last activity:** 2026-07-03 — `Sense.ru` translation column (fix: кириллический `q` не находил ничего, т.к. искал в `gloss`, а корпус держит там английское определение). Миграция 0003.
