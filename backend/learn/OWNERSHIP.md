...
- [x] проверка ответов дрилла (ADR 069 фаза 2) — `POST /learn/drills/{id}/check` + санитизация выдачи; checker живёт в learn-BFF (решение user: проверка на бэке, «фронты это просто интерфейсы»). Mock-tested (41 pass); **live-acceptance pending round-2 import** (lang.db без lessons/drills-контента → `/lang/drills/*` 404; проверено 2026-07-04)
