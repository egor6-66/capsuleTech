 ...
 *
 * `mock` — 200 сидированных карточек для мок-сборки (DataTable scroll/DnD/карта).
 ...
 * `Entities.Incident.schema`. В сборке без моков `__CAPSULE_MOCKS__` → `false`,
...
const Incident = Entity((z) => {
  ...
  return {
    schema,
    mock: __CAPSULE_MOCKS__ ? makeMock() : [],
  };
});
