  ...
  return (
    <Accordion bordered multiple>
      <Accordion.Item value="theme">
        ...
        <Accordion.Content>
          <Flex direction="col" gap={2} px={1} class="pt-1">
            <Toggle
              checked={activeDark()}
              label="Тёмный режим"
          ...
          <Flex direction="col" gap={1} w="full" px={1} py={2}>
            <For each={DISCOVERED_THEMES}>
              {(name) => (
                ...
                >
                  <Flex inline w={4} aria-hidden="true">
                    <Show when={activeTheme() === name}>
                      <Typography as="span" tone="primary">
                        &#x2713;
                      </Typography>
                    </Show>
                  </Flex>
