...
Без deps на zod/manifests — design-time концерны живут в `@capsuletech/web-ui-creator`. Этот пакет можно подключить в прод-приложение, которое отображает редактируемые страницы, без overhead'а редакторской зоны.
