 ...
 *  12. item: { use, props } из arg2 config → передаётся в шаблон как `item` prop (ADR 036)
...
// ---------------------------------------------------------------------------
// 12. item: { use, props } из arg2 передаётся в шаблон как `item` prop
// ---------------------------------------------------------------------------

describe('Shape v2 — item batch element from config (arg2)', () => {
