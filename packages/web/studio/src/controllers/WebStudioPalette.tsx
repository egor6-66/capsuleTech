/**
 * WebStudio.Palette — палитра компонентов для визуального редактора (ADR 032, фаза 6, чанк 3).
 *
 * Источники данных:
 ...
 */
const registryFromKit = (kit: ReturnType<typeof useWebStudioKit>): Registry =>
  ({ ui: kit }) as unknown as Registry;

// ── WebStudio.Palette ─────────────────────────────────────────────────────────

/**
 * WebStudio.Palette — монтируется внутри `<WebStudio.Provider>`.
 *
 * Нет внешних props — всё берётся из manifests/generators и kit-context.
 */
export const WebStudioPalette = () => {
