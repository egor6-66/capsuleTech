 ...
 * Контент-кит (useWebStudioKit) в WebStudioTree не используется.
 */
...
const { WebStudioTree } = await import('../WebStudioTree');
...
const mount = (ctx: IWebStudioCtx) => {
  ...
  render(() => <WebStudioTree />, container);
  return container;
};
...
describe('WebStudioTree — render корневого узла', () => {
...
describe('WebStudioTree — рендер иерархии', () => {
...
describe('WebStudioTree — emit onSelect', () => {
...
describe('WebStudioTree — emit onMark', () => {
...
describe('WebStudioTree — toggle collapse', () => {
...
describe('WebStudioTree — icons kit', () => {
...
describe('WebStudioTree — DnD zone резолв', () => {
