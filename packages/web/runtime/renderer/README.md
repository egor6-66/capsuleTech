...
Без deps на zod/manifests — authoring концерны живут в `@capsuletech/web-studio`. Этот пакет можно подключить в прод-приложение, которое отображает редактируемые страницы, без overhead'а редакторской зоны.
