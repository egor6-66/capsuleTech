...
import type { Accordion } from '@capsuletech/web-ui/accordion';
import type { Article } from '@capsuletech/web-ui/article';
...
import type { SectionedList } from '@capsuletech/web-ui/sectionedList';
...
type ViewUiRaw = UniversalUiRaw & {
  ...
  SectionedList: typeof SectionedList;
